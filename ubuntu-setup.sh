...
apt update ;
apt dist-upgrade -y ;
apt install -y git vim fish evolution tlp guake gnome-sushi nextcloud-client seafile-gui papirus-icon-theme arc-theme fcitx fcitx-hangul sublime-text vlc network-manager-openvpn-gnome gnome-tweak-tool steam ;
